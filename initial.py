...
def longitude_cluster(data,delta=0.5,lat_ascending=True,cluster=[0],theta=0.06,XXX=300):
    ...
    data.sort_values(by=['lgrid','xgrid'],inplace=True,ascending=lat_ascending);
...
gifts.sort_values(by='GiftId', inplace=True);
...
gifts.sort_values(by=['TripId','Latitude'],inplace=True,ascending=False);
